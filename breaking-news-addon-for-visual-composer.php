 ...
 * Version: 1.0.5
 * Description: This WP Bakery Page Builder addon allows you to create an animated breaking news ticker for your site within a few minutes.
...
if ( ! class_exists( 'BNM_VC_Addon' ) ) {
    ...
    class BNM_VC_Addon {
        ...
        public function __construct() {
            ...
            define( 'BNM_VC_PLUGIN_VERSION', '1.0.5' );
      ...
      <div class="notice notice-error">
        ...
        function includeFiles() {
            ...
            include_once BNM_VC_PLUGIN_PATH . '/includes/bnm-vc-helpers.php';

            if ( is_admin() ) {
                include_once BNM_VC_PLUGIN_PATH . '/includes/bnm-vc-element.php';

                // Auto Updater Scripts.
                include_once BNM_VC_PLUGIN_PATH . '/includes/autoupdater/WpAutoUpdater.php';
                include_once BNM_VC_PLUGIN_PATH . '/includes/autoupdater/installer.php';
                include_once BNM_VC_PLUGIN_PATH . '/includes/autoupdater/updater.php';
            }
        }
        ...
        function bnmVcLoadTranslationFile() {
            load_plugin_textdomain( 'bnm_vc', false, plugin_basename( __DIR__ ) . '/languages/' );
        }
    }
